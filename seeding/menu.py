...
ingredients = [
    Ingredient(Translation(en="Black Tea", es="Té Negro", de="Schwarzer Tee", fr="Thé Noir"), Translation(en="Tea", es="Té", de="Tee", fr="Thé"), 100, 0, 0.10, False, False, 2, 0, 0, 0, 0, 50, "None"), #0
    Ingredient(Translation(en="Green Tea", es="Té Verde", de="Grüner Tee", fr="Thé Vert"), Translation(en="Tea", es="Té", de="Tee", fr="Thé"), 100, 0, 0.12, False, False, 2, 0, 0, 0, 0, 35, "None"), #1
    Ingredient(Translation(en="Oolong Tea", es="Té Oolong", de="Oolong-Tee", fr="Thé Oolong"), Translation(en="Tea", es="Té", de="Tee", fr="Thé"), 100, 0, 0.15, False, False, 2, 0, 0, 0, 0, 40, "None"), #2
    Ingredient(Translation(en="Thai Tea Mix", es="Mezcla de Té Tailandés", de="Thai-Tee-Mischung", fr="Mélange de Thé Thaï"), Translation(en="Tea", es="Té", de="Tee", fr="Thé"), 100, 0, 0.20, False, False, 120, 0, 50, 28, 24, 40, "None"), #3
    Ingredient(Translation(en="Matcha Powder", es="Polvo de Matcha", de="Matcha-Pulver", fr="Poudre de Matcha"), Translation(en="Tea", es="Té", de="Tee", fr="Thé"), 100, 0, 0.50, False, False, 5, 0, 0, 1, 0, 35, "None"), #4
    Ingredient(Translation(en="Coffee", es="Café", de="Kaffee", fr="Café"), Translation(en="Coffee", es="Café", de="Kaffee", fr="Café"), 100, 0, 0.25, False, False, 2, 0, 0, 0, 0, 95, "None"), #5
    Ingredient(Translation(en="Whole Milk", es="Leche Entera", de="Vollmilch", fr="Lait Entier"), Translation(en="Dairy", es="Lácteos", de="Milchprodukte", fr="Produits Laitiers"), 100, 0, 0.30, False, False, 150, 8, 120, 12, 12, 0, "Milk"), #6
    Ingredient(Translation(en="Sweetened Condensed Milk", es="Leche Condensada Azucarada", de="Gesüßte Kondensmilch", fr="Lait Concentré Sucré"), Translation(en="Dairy", es="Lácteos", de="Milchprodukte", fr="Produits Laitiers"), 100, 0, 0.40, False, False, 130, 3, 50, 22, 22, 0, "Milk"), #7
    Ingredient(Translation(en="Coconut Milk", es="Leche de Coco", de="Kokosmilch", fr="Lait de Coco"), Translation(en="Dairy", es="Lácteos", de="Milchprodukte", fr="Produits Laitiers"), 100, 0, 0.35, False, False, 45, 4, 15, 2, 1, 0, "Tree nuts (Coconut)"), #8
    Ingredient(Translation(en="Heavy Cream", es="Crema Espesa", de="Schlagsahne", fr="Crème Épaisse"), Translation(en="Dairy", es="Lácteos", de="Milchprodukte", fr="Produits Laitiers"), 100, 0, 0.45, False, False, 200, 22, 40, 2, 1, 0, "Milk"), #9
    Ingredient(Translation(en="Cream Cheese", es="Queso Crema", de="Frischkäse", fr="Fromage à la Crème"), Translation(en="Dairy", es="Lácteos", de="Milchprodukte", fr="Produits Laitiers"), 100, 0, 0.60, False, False, 80, 8, 90, 1, 1, 0, "Milk"), #10
    Ingredient(Translation(en="Vanilla Ice Cream", es="Helado de Vainilla", de="Vanilleeis", fr="Crème Glacée à la Vanille"), Translation(en="Dairy", es="Lácteos", de="Milchprodukte", fr="Produits Laitiers"), 100, 0, 0.75, True, False, 210, 11, 80, 24, 20, 0, "Milk"), #11
    Ingredient(Translation(en="Ube Ice Cream", es="Helado de Ube", de="Ube-Eis", fr="Crème Glacée à l'Ube"), Translation(en="Dairy", es="Lácteos", de="Milchprodukte", fr="Produits Laitiers"), 100, 0, 0.90, True, False, 220, 11, 80, 26, 22, 0, "Milk"), #12
    Ingredient(Translation(en="Simple Syrup", es="Jarabe Simple", de="Einfacher Sirup", fr="Sirop Simple"), Translation(en="Syrup", es="Jarabe", de="Sirup", fr="Sirop"), 100, 0, 0.05, False, False, 50, 0, 0, 14, 14, 0, "None"), #13
    Ingredient(Translation(en="Honey", es="Miel", de="Honig", fr="Miel"), Translation(en="Syrup", es="Jarabe", de="Sirup", fr="Sirop"), 100, 0, 0.20, False, False, 64, 0, 1, 17, 17, 0, "None"), #14
    Ingredient(Translation(en="Brown Sugar Syrup", es="Jarabe de Azúcar Morena", de="Brauner Zuckersirup", fr="Sirop de Sucre Brun"), Translation(en="Syrup", es="Jarabe", de="Sirup", fr="Sirop"), 100, 0, 0.25, False, False, 60, 0, 0, 16, 16, 0, "None"), #15
    Ingredient(Translation(en="Caramel Syrup", es="Jarabe de Caramelo", de="Karamellsirup", fr="Sirop de Caramel"), Translation(en="Syrup", es="Jarabe", de="Sirup", fr="Sirop"), 100, 0, 0.30, False, False, 70, 0, 5, 18, 17, 0, "None"), #16
    Ingredient(Translation(en="Mango Purée", es="Puré de Mango", de="Mangopüree", fr="Purée de Mangue"), Translation(en="Fruit", es="Fruta", de="Frucht", fr="Fruit"), 100, 0, 0.40, False, False, 60, 0, 1, 15, 13, 0, "Mango"), #17
    Ingredient(Translation(en="Passion Fruit Syrup", es="Jarabe de Maracuyá", de="Passionsfruchtsaft", fr="Sirop de Fruit de la Passion"), Translation(en="Fruit", es="Fruta", de="Frucht", fr="Fruit"), 100, 0, 0.45, False, False, 50, 0, 1, 13, 12, 0, "Passion Fruit"), #18
    Ingredient(Translation(en="Peach Syrup", es="Jarabe de Durazno", de="Pfirsichsirup", fr="Sirop de Pêche"), Translation(en="Fruit", es="Fruta", de="Frucht", fr="Fruit"), 100, 0, 0.35, False, False, 45, 0, 1, 12, 11, 0, "Peach"), #19
    Ingredient(Translation(en="Strawberry Purée", es="Puré de Fresa", de="Erdbeerpüree", fr="Purée de Fraise"), Translation(en="Fruit", es="Fruta", de="Frucht", fr="Fruit"), 100, 0, 0.40, False, False, 50, 0, 1, 12, 10, 0, "Strawberry"), #20
    Ingredient(Translation(en="Pineapple Juice", es="Jugo de Piña", de="Ananassaft", fr="Jus d'Ananas"), Translation(en="Fruit", es="Fruta", de="Frucht", fr="Fruit"), 100, 0, 0.30, False, False, 60, 0, 2, 15, 13, 0, "Pineapple"), #21
    Ingredient(Translation(en="Taro Powder", es="Polvo de Taro", de="Taro-Pulver", fr="Poudre de Taro"), Translation(en="Taro", es="Taro", de="Taro", fr="Taro"), 100, 0, 0.50, False, False, 100, 0, 10, 24, 6, 0, "None"), #22
    Ingredient(Translation(en="Black Tapioca Pearls", es="Perlas de Tapioca Negras", de="Schwarze Tapioka-Perlen", fr="Perles de Tapioca Noires"), Translation(en="Tapioca", es="Tapioca", de="Tapioka", fr="Tapioca"), 100, 0, 0.15, True, False, 100, 0, 5, 26, 15, 0, "None"), #23
    Ingredient(Translation(en="Brown Sugar Pearls", es="Perlas de Azúcar Morena", de="Braune Zuckerperlen", fr="Perles de Sucre Brun"), Translation(en="Tapioca", es="Tapioca", de="Tapioka", fr="Tapioca"), 100, 0, 0.20, True, False, 110, 0, 5, 28, 18, 0, "None"), #24
    Ingredient(Translation(en="Coffee Jelly", es="Gelatina de Café", de="Kaffee-Gelee", fr="Gelée de Café"), Translation(en="Jelly", es="Gelatina", de="Gelee", fr="Gelée"), 100, 0, 0.25, True, False, 20, 0, 5, 5, 3, 10, "None"), #25
    Ingredient(Translation(en="Honey Jelly", es="Gelatina de Miel", de="Honig-Gelee", fr="Gelée de Miel"), Translation(en="Jelly", es="Gelatina", de="Gelee", fr="Gelée"), 100, 0, 0.25, True, False, 40, 0, 5, 10, 8, 0, "None"), #26
    Ingredient(Translation(en="Lychee Jelly", es="Gelatina de Lichi", de="Litschi-Gelee", fr="Gelée de Litchi"), Translation(en="Jelly", es="Gelatina", de="Gelee", fr="Gelée"), 100, 0, 0.25, True, False, 35, 0, 5, 9, 7, 0, "Lychee"), #27
    Ingredient(Translation(en="Grass Jelly", es="Gelatina de Hierba", de="Gras-Gelee", fr="Gelée d'Herbe"), Translation(en="Jelly", es="Gelatina", de="Gelee", fr="Gelée"), 100, 0, 0.25, True, False, 30, 0, 5, 8, 6, 0, "None"), #28
    Ingredient(Translation(en="Red Beans (Sweetened)", es="Frijoles Rojos (Endulzados)", de="Rote Bohnen (Gesüßt)", fr="Haricots Rouges (Sucrés)"), Translation(en="Beans", es="Frijoles", de="Bohnen", fr="Haricots"), 100, 0, 0.20, False, False, 120, 0, 5, 24, 12, 0, "None"), #29
    Ingredient(Translation(en="Nata de Coco", es="Nata de Coco", de="Nata de Coco", fr="Nata de Coco"), Translation(en="Coconut", es="Coco", de="Kokosnuss", fr="Noix de Coco"), 100, 0, 0.25, False, False, 40, 0, 10, 11, 9, 0, "Tree nuts (Coconut)"), #30
    Ingredient(Translation(en="Oreo Cookies", es="Galletas Oreo", de="Oreo-Kekse", fr="Biscuits Oreo"), Translation(en="Cookies", es="Galletas", de="Kekse", fr="Biscuits"), 100, 0, 0.10, False, False, 53, 3, 40, 8, 4, 0, "Wheat; Milk; Soybeans"), #31
    Ingredient(Translation(en="Lemon Juice", es="Jugo de Limón", de="Zitronensaft", fr="Jus de Citron"), Translation(en="Fruit", es="Fruta", de="Frucht", fr="Fruit"), 100, 0, 0.15, False, False, 7, 0, 1, 2, 1, 0, "None"), #32
    Ingredient(Translation(en="Salt", es="Sal", de="Salz", fr="Sel"), Translation(en="Seasoning", es="Condimento", de="Gewürz", fr="Assaisonnement"), 100, 0, 0.02, False, False, 0, 0, 0, 0, 0, 0, "None"), #33
    Ingredient(Translation(en="Ice Cubes", es="Cubitos de Hielo", de="Eiswürfel", fr="Glaçons"), Translation(en="Ice", es="Hielo", de="Eis", fr="Glace"), 100, 0, 0.01, False, True, 0, 0, 0, 0, 0, 0, "None"), #34
    Ingredient(Translation(en="Crushed Ice", es="Hielo Picado", de="Crushed Ice", fr="Glace Pilée"), Translation(en="Ice", es="Hielo", de="Eis", fr="Glace"), 100, 0, 0.01, False, True, 0, 0, 0, 0, 0, 0, "None"), #35
]
